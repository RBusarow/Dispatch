  ...
  new.printWriter()
    .use { writer ->
      ...
      val dependencyMatchers = listOf(
        ...
        "org.jetbrains.kotlinx:kotlinx-coroutines-core:1.5.0-RC".toDependencyMatcher(),
        "org.jetbrains.kotlinx:kotlinx-coroutines-android:1.5.0-RC".toDependencyMatcher(),
        "org.jetbrains.kotlinx:kotlinx-coroutines-test:1.5.0-RC".toDependencyMatcher(),
