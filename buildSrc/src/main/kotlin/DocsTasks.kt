  ...
  new.printWriter()
    .use { writer ->
      ...
      val dependencyMatchers = listOf(
        ...
        "io.gitlab.arturbosch.detekt:detekt-api:1.17.0".toDependencyMatcher(),
        "io.gitlab.arturbosch.detekt:detekt-cli:1.17.0".toDependencyMatcher(),
        "io.gitlab.arturbosch.detekt:detekt-formatting:1.17.0".toDependencyMatcher(),
        "io.gitlab.arturbosch.detekt:detekt-test:1.17.0".toDependencyMatcher(),
