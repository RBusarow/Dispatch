...
dependencies {
  ...
  dependencySync("androidx.compose.foundation:foundation:1.0.1")
  dependencySync("androidx.compose.material:material-icons-core:1.0.1")
  dependencySync("androidx.compose.material:material-icons-extended:1.0.1")
  ...
  dependencySync("androidx.exifinterface:exifinterface:1.3.3")
  ...
  dependencySync("androidx.navigation:navigation-compose:2.4.0-alpha07")
  dependencySync("androidx.navigation:navigation-runtime-ktx:2.3.5")
  dependencySync("androidx.paging:paging-common:3.0.1")
  dependencySync("androidx.paging:paging-runtime:3.0.1")
  ...
  dependencySync("io.gitlab.arturbosch.detekt:detekt-cli:1.18.1")
  dependencySync("io.gitlab.arturbosch.detekt:detekt-formatting:1.18.1")
  dependencySync("io.gitlab.arturbosch.detekt:detekt-test:1.18.1")
  ...
  dependencySync("org.jetbrains.kotlin:kotlin-test-common:1.5.30")
  dependencySync("org.jetbrains.kotlin:kotlin-test:1.5.30")
