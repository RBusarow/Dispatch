...
fun DefaultCoroutineScope(
  ...
  override val coroutineContext = job + Dispatchers.Default + dispatcherProvider
}
...
fun IOCoroutineScope(
  ...
  override val coroutineContext = job + Dispatchers.IO + dispatcherProvider
}
...
fun MainCoroutineScope(
  ...
  override val coroutineContext = job + Dispatchers.Main + dispatcherProvider
}
...
fun UnconfinedCoroutineScope(
  ...
  override val coroutineContext = job + Dispatchers.Unconfined + dispatcherProvider
}
