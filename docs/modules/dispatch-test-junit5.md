...
In addition to all the functionality in [dispatch-dispatch-test], this module exposes a JUnit 5 [CoroutineTestExtension] and [CoroutineTest] annotation to handle set-up and tear-down of a [TestProvidedCoroutineScope].
...
dependencies {
  ...
  // the junit5 artifact also provides the dispatch-dispatch-test artifact
