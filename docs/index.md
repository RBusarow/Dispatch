...
| **artifact**                           | **features**                                   |
| -------------------------------------- | ---------------------------------------------- |
|[dispatch-android-lifecycle]            | [LifecycleCoroutineScope] <p> [LifecycleCoroutineScope.launchOnCreate] <p> [LifecycleCoroutineScope.launchOnStart] <p> [LifecycleCoroutineScope.launchOnResume] <p> [Flow.launchOnCreate] <p> [Flow.launchOnStart] <p> [Flow.launchOnResume] <p> [onNextCreate] <p> [onNextStart] <p> [onNextResume]
